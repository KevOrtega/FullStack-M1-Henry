...
function cacheFunction(cb) {
  ...
  */
  ...
  return function (number) {
    if(resultDB.hasOwnProperty(number)) return resultDB[number]

    Object.defineProperty(resultDB, number, {value: cb(number)})
    return resultDB[number]
  }
}
...
// let textoAsteriscos = function (str) {
//   return crearCadena.call(null, "*", "*", str)
// };
// let textoGuiones = function (str) {
//   return crearCadena.call(null, "-", "-", str)
// };
// let textoUnderscore = function (str) {
//   return crearCadena.call(null, "_", "_", str)
// }; 
